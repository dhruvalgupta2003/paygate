...
/**
 * @title PayGateReceipts
 * @notice Optional on-chain receipts + escrow for PayGate.
 * @dev PayGate itself verifies USDC settlement off-chain; this contract is
...
contract PayGateReceipts is AccessControl, ReentrancyGuard, Pausable {
