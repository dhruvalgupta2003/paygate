...
contract PayGateReceiptsTest is Test {
    PayGateReceipts internal rec;
    ...
    function setUp() public {
        usdc = new ERC20Mock();
        rec  = new PayGateReceipts(usdc, receiver, admin);
    ...
    function test_commit_duplicateReverts() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(PayGateReceipts.ReceiptAlreadyCommitted.selector, bytes32("n1")));
        rec.commitReceipt(bytes32("n1"), payer, 1_000, "/x");
        vm.stopPrank();
    }
    ...
    function test_refund_cannotRepeat() public {
        ...
        rec.commitReceipt(bytes32("n1"), payer, 1_000, "/x");
        rec.refundReceipt(bytes32("n1"), "test");
        vm.expectRevert(abi.encodeWithSelector(PayGateReceipts.ReceiptAlreadyRefunded.selector, bytes32("n1")));
