...
[![npm](https://img.shields.io/npm/v/@limen/node?color=5B4FE9)](https://www.npmjs.com/package/@limen/node)
...
| Entry | Purpose |
|-------|---------|
| `@limen/node` | Core types, `CoreProxy`, chain adapters, utilities. |
| `@limen/node/express` | Express middleware. |
| `@limen/node/fastify` | Fastify plugin. |
| `@limen/node/hono` | Hono middleware. |
| `@limen/node/next` | Next.js App Router handler. |

CLI: `limen start`, `limen doctor`, `limen verify`,
`limen config`, `limen keys`, `limen audit`.
