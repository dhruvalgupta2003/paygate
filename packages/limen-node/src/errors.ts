...
export interface LimenErrorInit {
...
export class LimenError extends Error {
  ...
  constructor(init: LimenErrorInit) {
  ...
  toJSON(): Readonly<Record<string, unknown>> {
    return {
      ...
      docs: `https://limen.dev/docs/errors#${this.code.toLowerCase()}`,
      ...this.extra,
    };
  }
}

export function isLimenError(e: unknown): e is LimenError {
  return e instanceof LimenError;
}
